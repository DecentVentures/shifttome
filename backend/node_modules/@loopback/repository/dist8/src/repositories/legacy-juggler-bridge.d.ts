...
export declare class DefaultCrudRepository<T extends Entity, ID> implements EntityCrudRepository<T, ID> {
     ...
     */
    protected _createHasManyRepositoryFactoryFor<Target extends Entity, TargetID, ForeignKeyType>(relationName: string, targetRepo: EntityCrudRepository<Target, TargetID>): HasManyRepositoryFactory<Target, ForeignKeyType>;
